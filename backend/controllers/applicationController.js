...
//@desc Get loggedin user's appplication
...
//@desc get all application for a job (employer)
exports.getApplicantForJob = async (req, res) => {
    try {
...
exports.updateStatus = async (req, res) => {
    try {
        ...
        if(!app || app.job.company.toString() !== req.user._id.toString()){
            return res.status(403).json({mesaage: "Not authorized to update this application"});
        }
