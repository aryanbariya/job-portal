          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div className="p-8">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={(e) =>
                        handleInputChange("companyDescription",
                          e.target.value
                        )
                      }
                      rows={4}
              ...
              <div className="flex justify-end space-x-4 mt-8 pt-6 border-t">
                ...
                className="px-6 py-6 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors flex items-center space-x-2"
                >
                  <X className="w-4 h-4"/>
                  <span>Cancel</span>
                </button>
