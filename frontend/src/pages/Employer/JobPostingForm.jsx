  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.status === 200 || response.status === 201) {
        toast.success(
          jobId ? "Job Updated Sucessfully" : "Job Posted Sucessfully"
        );
        setFormData({
          jobTitle: "",
          location: "",
          ...
          <div className="bg-white shadow-xl rounded-2xl p-6">
            ...
            <div className="space-y-6">
              ...
              <TextareaField
                ...
                helperText="Include key responsibilites, day-to-day tasks, amd what makes this role exciting"
                required
              />
                ...
                <div className="grid grid-cols-3 gap-3">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className='w-full pl-10 pr-3 py-2.5 border border-gray-300 rounded-lg text-base  focus:outline-none focus:ring-2 focus:ring-blue-500 focus:opacity-20  focus:border-blue-500 transition-colors duration-200' />
                  </div>
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none z-10">
                      <DollarSign className='h-5 w-5 text-gray-400' />
              ...
              <div className="p-2">
                <button
                  ...
                  className='w-full flex items-center justify-center px-4 py-3 border border-transparent text-base font-medium rounded-lg text-white bg-blue-600 hover:bg-blue-700 focus:ring-offset-2 focus:ring-blue-500 disabled:bg-gray-400 disabled:cursor-not-allowed  outline-none transition-colors duration-200'
                >
                  {isSubmitting ? (
                    <>
