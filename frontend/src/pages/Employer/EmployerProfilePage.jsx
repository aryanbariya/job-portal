...
const EmployerProfilePage = () => {
  ...
  //   } catch (error) {
  //     console.error((prev) => ({...prev, [type]: false}))
  //   }
  // };
      ...
      <div className="min-h-screen bg-gray-50 py-8 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-xl shadow-lg overflow-hidden">  
            {/* Header */}
            <div className="bg-gradient-to-r from-blue-600 to-blue-600 px-8 py-6 flex justify-between items-center">
            ...
            <div className="p-8">
              ...
              {/* Company Description */}
              <div className="mt-8">
                <h2 className="text-lg font-semibold text-gray-800 borer-b border-gray-200 pb-2 mb-6">
                  About Company
                </h2>
