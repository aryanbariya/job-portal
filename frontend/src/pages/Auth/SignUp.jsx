...
const SignUp = () => {
  ...
  return (
    <div className="min-screen flex items-center justify-center bg-gray-50 px-4 py-8">
      <motion.div
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={handleInputChange}
                className={`w-full pl-10 pr-4 py-3 rounded-lg border ${formState.errors.email ? 'border-red-500' : 'border-gray-500'
                  }focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors`}
