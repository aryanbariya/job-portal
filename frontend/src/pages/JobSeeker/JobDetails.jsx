...
const JobDetails = () => {
  ...
  const getJobDetailsById = async () => {
    try {
      ...
      console.error("Error fetching job detials", error);
    }
  }

  const applyTobjob = async () => {
    try {
      if(jobId){
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-3 mb-6">
                  {jobDetails?.company?.companyLogo ? (
                    <img src={jobDetails?.company} 
                    alt="Company Logo"
                    className="h-20 w-20 object-cover rounded-2xl border-4 border-white/20 shadoe-lg" />
                  ) : (
                  ...
                  {jobDetails?.applicationStatus ? (
                    ...
                    onClick={applyTobjob}>Apply Now</button>
                  )}
                </div>
            ...
            <div className="px-0 pb-8 space-y-8">
              ...
              <div className="relative overflow-hidden bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-100 p-6 rounded-2xl">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-gradient-to-br from-purple-500 to-pink-50 border border-purple-100 rounded-xl p-6">
                    <div className="text-sm text-gray-700 leading-relaxed whitespace-pre-wrap">
